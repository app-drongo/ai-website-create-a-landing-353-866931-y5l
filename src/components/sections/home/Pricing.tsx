...
export default function Pricing() {
  ...
  const plans = [
    {
      name: 'Starter',
      description: 'Perfect for small businesses testing form automation',
      price: 'Free',
      period: '',
      badge: null,
      features: [
    ...
    {
      name: 'Enterprise',
      description: 'Custom form solutions for large organizations',
      price: 'Custom',
      period: '',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-8">
            From simple contact forms to complex multi-step workflows. Choose the plan that grows
            with your form automation needs.
          </p>
        ...
        <div className="text-center mt-16 max-w-2xl mx-auto">
          <h3 className="text-xl font-semibold mb-4">Need custom form integrations?</h3>
          <p className="text-muted-foreground mb-6">
            Our enterprise solutions include custom field types, advanced workflow automation, and
            dedicated infrastructure for high-volume form processing.
          </p>
