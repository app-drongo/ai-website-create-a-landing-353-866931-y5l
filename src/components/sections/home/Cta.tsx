...
export default function Cta() {
  ...
  const stats = [
    { value: '25K+', label: 'Forms Created', icon: Users },
    { value: '99.9%', label: 'Uptime', icon: Shield },
    { value: '200+', label: 'Templates', icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Create stunning, responsive forms in minutes with FormFlow's intuitive drag-and-drop
                builder. Collect data, automate workflows, and boost conversions effortlessly.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Deploy your first form in under 5 minutes
              </p>
            </div>
          </div>
        </div>
